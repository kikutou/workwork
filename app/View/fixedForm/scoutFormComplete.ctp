...
<div id="iframe">
			<div id="contents">
				...
				<p class="prt-flowChart"><img src="/sponsor/images/parts/formInput_img_03.png" alt="1.定型文の作成・編集 > 2.定型文の確認 > 3.保存完了" height="33" width="609"></p>
				<h3 class="prt-headingB"><img src="/sponsor/images/parts/scoutFormInput_tit_01.png" alt="スカウトメール" height="30" width="840"></h3>
					<p>定型文の保存を完了しました。</p>
