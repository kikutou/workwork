...
<div class="section">
<p class="notes">パスワードの変更を完了しました。<br clear="none" />下記のボタンより再度ログインを実行してください。</p>


<div class="prt-buttonUnit_type01_login">
<a shape="rect" href="../login/index"><img src="/sponsor/images/common/btn_toLogin_01.png" class="js-hoverSwap" type="image" height="32" alt="ログイン画面へ" width="190" /></a>
</div><!-- /.prt-buttonUnit_type01 -->
</div><!-- /.section -->
