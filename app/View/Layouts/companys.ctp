...
<div class="container">
    <?php echo $this->Html->image('companys/company_banner.jpg', array('alt'=>'company banner', 'class'=>'img-responsive', 'style'=>'width:100%; margin-top:20px;'));?>
</div>
